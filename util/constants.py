...
GC_CELL_FPATH = Path("/home/icml007/Nightmare4214/datasets/ocelot2023_v1.0.1/images/val/cell")
GC_TISSUE_FPATH = Path("/home/icml007/Nightmare4214/datasets/ocelot2023_v1.0.1/images/val/tissue")

GC_METADATA_FPATH = Path("/home/icml007/Nightmare4214/datasets/ocelot2023_v1.0.1/metadata.json")

# Grand Challenge output file
GC_DETECTION_OUTPUT_PATH = Path("test/output/val_cell_classification.json")
